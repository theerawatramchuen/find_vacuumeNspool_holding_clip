...
def move_with_retry(src, dst, max_retries=5, delay=0.5):
    ...
    for attempt in range(max_retries):
        try:
            ...
            # Windows error 32 = file in use; also catch general permission errors
...
# ----------------------------------------------------------------------
# Embedded HTML template (Bootstrap 5, video players)
# ----------------------------------------------------------------------
INDEX_HTML = """
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        {% if input_videos %}
                            <p class="hint">⚠️ Stop video playback before clicking the button to avoid file‑lock errors.</p>
